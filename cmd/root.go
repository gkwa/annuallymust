...
import (
	...
	"github.com/gkwa/annuallymust/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.annuallymust.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".annuallymust")
	}
